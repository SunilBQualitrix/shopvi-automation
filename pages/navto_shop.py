...
class NavtoShop(BasePage):
    ...
    def click_number_input_field(self):
        """
        Handles the USB Debugging popup if displayed and clicks the number input field if visible.
        Returns:
        True if the number input field is successfully clicked, False otherwise.
        """
        ...
        if mobile_num_input:
            ...
            self.actions.screenshotAttachment("Mobile Number Input Field Clicked")
            return True
        else:
            allureLogs("Mobile Number Input Field is not displayed.")
            self.actions.screenshotAttachment("Mobile Number Input Field not displayed")
            return False
    ...
    def click_dialog_box(self):
        ...
        if dialog_box_header:
            allureLogs("Number Dialog Box is displayed. Clicking the cancel button.")
